...
/** 
 * Client.java
 * Interacts with Server via networking
 * Loads save data from Server
 */
...
public class Client {
    ...
    public Client(String address, int port) throws IOException {
        ...
        try {
            ...
            ordersData = in.readUTF();
            System.out.println("Order Data Received");
            menuData = in.readUTF();
            System.out.println("Menu Data Received");
            POSInstance = new POS(ordersData, menuData, socket, false);
    ...
    public void interpretSentString(String sentStr) {
        ...
        if (proposed instanceof Category) {
            ...
            } else if (categoryWithinMenu.getFoodItems().get(foodItemIndexWithinCategory).equals(proposedFoodItem)) // if
                                                                                                                    // they
                                                                                                                    // are
                                                                                                                    // the
                                                                                                                    // same,
            ...
            int orderIndexWithinOrdersTableModel = POSInstance.searchByOrderIDInOrdersTableModel(proposedOrder.getID());
